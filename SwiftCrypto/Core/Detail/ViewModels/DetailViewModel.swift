...
class DetailViewModel: ObservableObject{
   ...
   private func createOverviewArray(coinModel: CoinModel) -> [StatisticModel] {
        let price = coinModel.currentPrice.asCurrenceWith6Decimals()
   ...
   private func createAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
        let high = coinModel.high24H?.asCurrenceWith6Decimals() ?? "n/a"
        let highStat = StatisticModel(title: "24h High", value: high)
        
        let low = coinModel.low24H?.asCurrenceWith6Decimals() ?? "n/a"
        let lowStat = StatisticModel(title: "24 h Low", value: low)
        
        let priceChange = coinModel.priceChange24H?.asCurrenceWith6Decimals() ?? "n/a"
        let pricePercentChange = coinModel.priceChangePercentage24H
